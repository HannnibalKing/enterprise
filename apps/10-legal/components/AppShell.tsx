  ...
  return (
    <div className="shell">
      <aside className="sidebar">
        <div className="sidebar-logo">LEXIS LEGAL<span>Case Management System</span></div>
      ...
      <div className="main">
        <header className="topbar">
          <span className="topbar-title">{NAV.find(n=>n.href===pathname)?.label ?? 'LEXIS LEGAL'}</span>
