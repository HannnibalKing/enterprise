    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      <aside style={{ width: 210, background: 'var(--surface)', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', padding: '20px 0' }}>
        <div style={{ padding: '0 20px 24px' }}>
          <div style={{ fontSize: 18, fontWeight: 900, letterSpacing: '0.08em', color: 'var(--accent)' }}>VANTAGE</div>
          <div style={{ fontSize: 9, color: 'var(--text-muted)', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase', marginTop: 2 }}>PMO Suite</div>
        </div>
        ...
        <div style={{ padding: '16px 20px', borderTop: '1px solid var(--border)' }}>
          ...
          <div style={{ fontSize: 10, color: 'var(--text-muted)', marginBottom: 10 }}>{userRole.replace(/_/g,' ')}</div>
